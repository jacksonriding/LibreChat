...
- **Code Interpreter workflows:** Code and shell tools can run in the background, sandbox images return as viewable artifacts, and highly experimental stateful sessions use dedicated routing, selectable workspace scopes, and a personal default for new Agents.
...
- **Messages and navigation:** A full-screen swipeable mobile drawer, aligned message and composer columns, long-paste and attachment-only turns, code-block downloads, assistant-text copy, virtualized search, smooth streaming, and faster Agent startup.
